...
<![if !supportLists]>1. <![endif]>Create the path object.

<![if !supportLists]>2. <![endif]>Set any relevant drawing attributes of your `UIBezierPath` object, such as the `[lineWidth](https://developer.apple.com/documentation/uikit/uibezierpath/1624349-linewidth)` or `[lineJoinStyle](https://developer.apple.com/documentation/uikit/uibezierpath/1624378-linejoinstyle)` properties for stroked paths or the `[usesEvenOddFillRule](https://developer.apple.com/documentation/uikit/uibezierpath/1624360-usesevenoddfillrule)` property for filled paths. These drawing attributes apply to the entire path.

<![if !supportLists]>3. <![endif]>Set the starting point of the initial segment using the `[moveToPoint:](https://developer.apple.com/documentation/uikit/uibezierpath/1624343-movetopoint)` method.

<![if !supportLists]>4. <![endif]>Add line and curve segments to define a subpath.

<![if !supportLists]>5. <![endif]>Optionally, close the subpath by calling `[closePath](https://developer.apple.com/documentation/uikit/uibezierpath/1624338-close)`, which draws a straight line segment from the end of the last segment to the beginning of the first.

<![if !supportLists]>6. <![endif]>Optionally, repeat the steps 3, 4, and 5 to define additional subpaths.
...
<![if !vml]>![https://developer.apple.com/library/archive/documentation/2DDrawing/Conceptual/DrawingPrintingiOS/Art/bezier_pentagon_2x.png](file:////Users/doleduy/Library/Group%20Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image001.png)<![endif]>
...
<![if !vml]>![https://developer.apple.com/library/archive/documentation/2DDrawing/Conceptual/DrawingPrintingiOS/Art/arc_layout_2x.png](file:////Users/doleduy/Library/Group%20Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image002.png)<![endif]>
...
<![if !vml]>![https://developer.apple.com/library/archive/documentation/2DDrawing/Conceptual/DrawingPrintingiOS/Art/curve_segments_2x.png](file:////Users/doleduy/Library/Group%20Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image003.png)<![endif]>

To add curves to a path, you use the following methods:

<![if !supportLists]>· <![endif]>**Cubic curve:**`[addCurveToPoint:controlPoint1:controlPoint2:](https://developer.apple.com/documentation/uikit/uibezierpath/1624357-addcurve)`

<![if !supportLists]>· <![endif]>**Quadratic curve:**`[addQuadCurveToPoint:controlPoint:](https://developer.apple.com/documentation/uikit/uibezierpath/1624351-addquadcurvetopoint)`
...
<![if !supportLists]>· <![endif]>Set the desired stroke and fill colors using the methods of the `[UIColor](https://developer.apple.com/documentation/uikit/uicolor)` class.

<![if !supportLists]>· <![endif]>Position the shape where you want it in the target view.
...
<![if !supportLists]>· <![endif]>Update the drawing attributes of the path object. The drawing attributes of your `UIBezierPath` instance override the values associated with the graphics context when rendering the path.
